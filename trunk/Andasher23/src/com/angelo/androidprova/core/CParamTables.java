...
public class CParamTables {
    ...
    public bp_table[] BoolParamTable = {
        ...
        new bp_table(Ebp_parameters.BP_TRAINING, "Training", !PERS, false, "Provides locking during training (deprecated)"),
    ...
    public lp_table[] LongParamTable = {
        ...
        new lp_table(Elp_parameters.LP_MAX_BITRATE, "MaxBitRateTimes100", PERS, 140, "Max Bit Rate Times 100"),
    ...
    public sp_table[] StringParamTable = {
        ...
        new sp_table(Esp_parameters.SP_SYSTEM_LOC, "SystemLocation", !PERS, "system.rc/", "System Directory"),
        // TODO: make the user directory actually do something
        new sp_table(Esp_parameters.SP_USER_LOC, "UserLocation", !PERS,
        System.getProperty("user.home") + System.getProperty("file.separator") + ".dasher" + System.getProperty("file.separator"),
        "User Directory"),
    ...
    static private final int lp_offset = Ebp_parameters.NUMBER_OF_VALUES;
    ...
    public class lp_table {
        ...
        public lp_table(Elp_parameters k, String rName, boolean pers, long def, String hr) {
        	//Log.e("Constructor", "lp_table");
            key = k.value + lp_offset;
            humanReadable = hr;
            persistent = pers;
            defaultVal = def;
            value = def;
    ...
    static private final int sp_offset = Ebp_parameters.NUMBER_OF_VALUES + Elp_parameters.NUMBER_OF_VALUES;
    ...
    public class sp_table {
        ...
        //	Log.e("Constructor", "sp_table");
            key = k.value + sp_offset;
            humanReadable = hr;
            persistent = pers;
            defaultVal = def;
            value = def;
