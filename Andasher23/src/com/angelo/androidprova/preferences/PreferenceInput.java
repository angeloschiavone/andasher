 ...
 */
public class PreferenceInput extends Preference implements
AdapterView.OnItemSelectedListener {
 
	private int input = -1;
	
	public static int INPUT_TOUCH = 0;
	public static int INPUT_SENSOR = 1;
	
	
	// This is the constructor called by the inflater
	public PreferenceInput(Context context, AttributeSet attrs) {
		super(context, attrs);

		setWidgetLayoutResource(R.layout.input_widget);
	...
	protected void onBindView(View view) {
		...
		final Spinner mySpinner = (Spinner) view.findViewById(R.id.SpinnerInput);
		if (mySpinner != null) {
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int position,
		...
		//CSettingsStore.instance.SetLongParameter(Elp_parameters.LP_MAX_BITRATE, input*30);
