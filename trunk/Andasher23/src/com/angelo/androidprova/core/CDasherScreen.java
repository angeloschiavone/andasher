...
public interface CDasherScreen {
	 ...
	 */
	public abstract Point TextSize(String string, int Size);
  ...
  /** Draw a filled rectangle
	...
	*/
	 ...
	 */
	public abstract void Polyline(Point[] Points, int Number, int iWidth) ;
	 ...
	 */
	public abstract void Polyline(Point[] Points, int Number, int iWidth, int Colour);
	...
	*/
	public abstract void Polygon(Point[] Points, int Number, int Color);
	...
	*/
	public abstract void Polygon(Point[] Points, int Number, int Color, int iWidth);
