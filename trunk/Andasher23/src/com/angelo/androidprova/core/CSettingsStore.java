...
public class CSettingsStore {
	...
	public static CSettingsStore instance;
	...
	//	Log.e("Constructor", "CSettingsStore");
	...
	public void LoadPersistent() {
		...
		for(int i = 0; i < Ebp_parameters.NUMBER_OF_VALUES; ++i) {
		...
		for(int j = 0; j < Elp_parameters.NUMBER_OF_VALUES; ++j) {
		...
		for(int k = 0; k < Esp_parameters.NUMBER_OF_VALUES; ++k) {
	...
	public void SetBoolParameter(Ebp_parameters iParameter, boolean bValue) {
		...
		// Set the value
		s_oParamTables.BoolParamTable[iParameter.value].value = bValue;
		...
		if(s_oParamTables.BoolParamTable[iParameter.value].persistent)
			SaveSetting(s_oParamTables.BoolParamTable[iParameter.value].regName, bValue);
	}
	...
	public void SetLongParameter(Elp_parameters iParameter, long lValue) {
		...
		// Set the value
		s_oParamTables.LongParamTable[iParameter.value].value = lValue;
		...
		// Write out to permanent storage
		if(s_oParamTables.LongParamTable[iParameter.value].persistent)
			SaveSetting(s_oParamTables.LongParamTable[iParameter.value].regName, lValue);
	}
	...
	public void SetStringParameter(Esp_parameters iParameter, String sValue) {
		...
		// Set the value
		s_oParamTables.StringParamTable[iParameter.value].value = sValue;
		...
		// Write out to permanent storage
		if(s_oParamTables.StringParamTable[iParameter.value].persistent)
			SaveSetting(s_oParamTables.StringParamTable[iParameter.value].regName, sValue);
	}
	...
	public boolean GetBoolParameter(Ebp_parameters iParameter) {
		...
		// Return the value
		return s_oParamTables.BoolParamTable[iParameter.value].value;
	}
	...
	public long GetLongParameter(Elp_parameters iParameter) {
		...
		// Return the value
		return s_oParamTables.LongParamTable[iParameter.value].value;
	}
	...
	public String GetStringParameter(Esp_parameters iParameter) {
		// Return the value
		return s_oParamTables.StringParamTable[iParameter.value].value;
	}
	...
	public void ResetParameter(EParameters iParameter) {
		...
		case ParamBool:
			SetBoolParameter((Ebp_parameters)iParameter, s_oParamTables.BoolParamTable[((Ebp_parameters)iParameter).value].defaultVal);
			break;
		case ParamLong:
			SetLongParameter((Elp_parameters)iParameter, s_oParamTables.LongParamTable[((Elp_parameters)iParameter).value].defaultVal);
			break;
		case ParamString:
			SetStringParameter((Esp_parameters)iParameter, s_oParamTables.StringParamTable[((Esp_parameters)iParameter).value].defaultVal);
			break;
		}
	}
	...
	public String GetParameterName(EParameters iParameter)
	{
		...
		case (ParamBool):
		{
			return s_oParamTables.BoolParamTable[((Ebp_parameters)iParameter).value].regName;
		}
		case (ParamLong):
		{
			return s_oParamTables.LongParamTable[((Elp_parameters)iParameter).value].regName;
		}
		case (ParamString):
		{
			return s_oParamTables.StringParamTable[((Esp_parameters)iParameter).value].regName;
		}
		};
