...
//        m_AutoSpeedControl = new CAutoSpeedControl(m_EventHandler, m_SettingsStore, m_DasherModel.Framerate());
    ...
    public boolean Timer(long Time, CDasherView m_DasherView, CDasherModel m_DasherModel) {
        ...
        DPoint inputCoords = m_DasherView.getInputDasherCoords();
        ...
        boolean bDidSomething = m_DasherModel.Tap_on_display(inputCoords.x, inputCoords.y, Time, null);
     ...
     */
    long[] CoordinatesDrawMouse = new long[2];
    public void DrawMouse(CDasherView View) {

        int iType = (View.GetCoordinates(2, CoordinatesDrawMouse));

        int mousex= (int) Coordinates[0];
        int mousey = (int) Coordinates[1];
        ...
        DPoint dashXY = View.Input2Dasher(mousex, mousey, iType, mode);
...
int iType = (View.GetCoordinates(2, Coordinates));
        int mousex;
        int mousey;
        ...
        DPoint newXY = View.Input2Dasher(mousex, mousey, iType, mode);
        x[1] = newXY.x;
        y[1] = newXY.y;
        newXY.release();
