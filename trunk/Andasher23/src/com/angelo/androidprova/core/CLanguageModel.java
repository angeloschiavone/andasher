...
public abstract class CLanguageModel extends CDasherComponent {
	 ...
	 */
	public abstract CPPMContext CreateEmptyContext();
	 ...
	 */
	public abstract CPPMContext CloneContext(CPPMContext Context);
	 ...
	 */
	public abstract LongArrayPool GetProbs(CContextBase Context , long iNorm);
