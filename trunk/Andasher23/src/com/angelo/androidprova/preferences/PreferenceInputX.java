 ...
 */
public class PreferenceInputX extends Preference implements
	...
	public PreferenceInputX(Context context, AttributeSet attrs) {
		super(context, attrs);

		setWidgetLayoutResource(R.layout.input_x_widget);
	...
	protected void onBindView(View view) {
		...
		final Spinner mySpinner = (Spinner) view
				.findViewById(R.id.SpinnerInputX);
		if (mySpinner != null) {
